...
const GalleryImage = (props: Props) => {
  const { loadImage, src, alt, transforms } = props;
  ...
  return (
    ...
    >
      ...
      <p className="transition-all duration-150 ease-in invisible group-hover:visible text-2xl font-extrabold absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 drop-shadow-lg">
